        ...
        <div class="team-box">
			...
			?>
				<div class="team-description">
					<div class="team-el">
						<?php
						if (!empty($instance['name'])): echo ' <h4 class="team-name">' . esc_html($instance['name']) . '</h4>';
						endif;
						?>
						<?php
...
add_action('widgets_init', create_function('', 'return register_widget( "MP_Profit_Plugin_Widget_Team" );'));
