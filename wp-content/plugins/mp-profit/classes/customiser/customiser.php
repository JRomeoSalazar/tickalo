		...
		*/
		...
		$wp_customize->add_section(
			$this->getPrefix() . 'stock_ticker_section', array(
				'title'       => __( 'Stock Ticker Section', 'mp-profit' ),
				'priority'    => 80,
				'capability'  => 'edit_theme_options',
				'description' => __( '<i>Fill in this section by adding "Theme - Stock Ticker" widgets to "Customize > Widgets > Stock Ticker section"</i><hr/>', 'mp-profit' )
			)
		);
		...
		*/
		...
		$wp_customize->add_section(
			$this->getPrefix() . 'first_action_section', array(
				'title'      => __( 'First to Call Action Section', 'mp-profit' ),
				'priority'   => 82,
				'capability' => 'edit_theme_options'
			)
		);
