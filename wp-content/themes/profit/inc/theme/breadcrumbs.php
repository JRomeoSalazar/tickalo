    ...
    elseif (is_archive()) {
        ...
        elseif (is_time()) {
            ...
            if (get_query_var('minute') && get_query_var('hour'))
                $trail['trail_end'] = get_the_time(__('g:i a',  'profit' ));

            elseif (get_query_var('minute'))
                $trail['trail_end'] = sprintf(__('Minute %1$s',  'profit' ), get_the_time(__('i',  'profit' )));

            elseif (get_query_var('hour'))
                $trail['trail_end'] = get_the_time(__('g a',  'profit' ));
        }
        ...
        elseif (is_date()) {
            ...
            if (is_day()) {
                $trail[] = '<a href="' . get_year_link(get_the_time('Y')) . '" title="' . get_the_time(esc_attr__('Y',  'profit' )) . '">' . get_the_time(__('Y',  'profit' )) . '</a>';
                $trail[] = '<a href="' . get_month_link(get_the_time('Y'), get_the_time('m')) . '" title="' . get_the_time(esc_attr__('F',  'profit' )) . '">' . get_the_time(__('F',  'profit' )) . '</a>';
                $trail['trail_end'] = get_the_time(__('j',  'profit' ));
            } elseif (get_query_var('w')) {
                $trail[] = '<a href="' . get_year_link(get_the_time('Y')) . '" title="' . get_the_time(esc_attr__('Y',  'profit' )) . '">' . get_the_time(__('Y',  'profit' )) . '</a>';
                $trail['trail_end'] = sprintf(__('Week %1$s',  'profit' ), get_the_time(esc_attr__('W',  'profit' )));
            } elseif (is_month()) {
                $trail[] = '<a href="' . get_year_link(get_the_time('Y')) . '" title="' . get_the_time(esc_attr__('Y',  'profit' )) . '">' . get_the_time(__('Y',  'profit' )) . '</a>';
                $trail['trail_end'] = get_the_time(__('F',  'profit' ));
            } elseif (is_year()) {
                $trail['trail_end'] = get_the_time(__('Y',  'profit' ));
            }
        }
    }

    /* If viewing search results. */ elseif (is_search())
        $trail['trail_end'] = sprintf(__('Search results for &quot;%1$s&quot;',  'profit' ), esc_attr(get_search_query()));

    /* If viewing a 404 error page. */
    elseif (is_404())
        $trail['trail_end'] = __('404 Not Found',  'profit' );
