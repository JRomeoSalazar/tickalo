...
function tickalo_enqueue_styles() {
	...
	wp_enqueue_script( 'mp-tickalo-script', get_stylesheet_directory_uri() . '/js/tickalo.min.js', array( 'mp-profit-script', 'flexslider' ), mp_profit_get_theme_version(), false );
}
